...
import com.example.symptomtracker.Route
import com.example.symptomtracker.navigation.TopLevelDestination
import com.example.symptomtracker.ui.logs.navigation.LOGS_ROUTE
import com.example.symptomtracker.ui.logs.navigation.navigateToLogs
...
class AppState(
    ...
    val currentTopLevelDestination: TopLevelDestination?
        @Composable get() = when (currentDestination?.route) {
            Route.HOME.name -> TopLevelDestination.HOME
    ...
    fun navigateToTopLevelDestination(topLevelDestination: TopLevelDestination) {
        ...
        when (topLevelDestination) {
            TopLevelDestination.HOME -> navController.navigate(Route.HOME.name, navOptions)
